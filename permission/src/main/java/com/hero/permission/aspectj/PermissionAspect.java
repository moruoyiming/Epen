package com.hero.permission.aspectj;

import android.content.Context;
import android.util.Log;

import com.hero.permission.activity.PermissionRequestActivity;
...
import com.hero.permission.util.ApplicationUtil;
...
public class PermissionAspect {
    ...
    @Pointcut("execution(@com.hero.permission.annotation.Permission * *(..)) && @annotation(permission)")
