...
import com.hero.basiclib.BuildConfig;
...
public class RetrofitClient {
    ...
    public static void updateHeader(Map<String, String> headers){
        httpHeaders = headers;
        baseInterceptor.setHeaders(headers);
    }

    private RetrofitClient() {
        this(baseUrl, httpHeaders);
    }
